...
@Component({
  ...
  template: `
    ...
    <br><hr><br>
    <h2 style="text-align:center">My Perspective on Design</h2>
    <section>
      ...
      <p>
        ...
        there is likely not a single answer because each our experiements involves the human experience. As individuals and
    ...
    <section>
      ...
      <div fxLayout="row" fxLayoutGap="20px">
        ...
        <p fxFlex="50%">
          Using the constructs used for A/B testing and machine learning, we can begin to offer truely customizable experiences.
          This can be used to accomodate for full spectum of users. Features can be released with the learning curve, one's
          cognative ability can be accounted for, even seperate palletes for the color blind. The variations are limitless and 
          can better serve each customer individually.
        </p>
      </div>
    </section>

    <section>
      <h3>Design Adds Value</h3>
      <br>
      <div fxLayout="row" fxLayoutGap="20px">
        <p fxFlex="50%">
        ...
        <div fxFlex="50%">
          ...
          <br><br>
          <p>
            Indeed, the design process is as critical to a business's success as operations. The first-mover advantage
