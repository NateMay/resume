...
@Component({
  ...
  <section>
    ...
    <p style="min-height: 300px">
      ...
      This is my team: the <b>Common UI</b> team. We manage libraries of reusable web components
      for several JavaScript frameworks and Citi applications. These libraries adhere to
      ...
      <a href="https://angular.io/" target="_blank">Angular</a> and I was able to personally implement many of our components
      ...
      <div fxFlex>
        ...
        <mat-list>
          <mat-list-item>
            ...
            <span class="add-margin">Adheres to Citi's Digital Design Language</span>
          </mat-list-item>
          <mat-list-item>
            <mat-icon style="color:green">check</mat-icon>
            <span class="add-margin">Certified for <a href="https://www.w3.org/TR/WCAG20/"> WCAG 2.0 AA</a> accessibility complience</span> 
          </mat-list-item>
          <mat-list-item>
            <mat-icon style="color:green">check</mat-icon>
            <span class="add-margin">Compatible with <a href="https://www.youtube.com/watch?v=GQzn7XRdzxY" target="_blank">server-side rendering</a></span> 
          </mat-list-item>
          <mat-list-item>
            <mat-icon style="color:green">check</mat-icon>
          ...
          <mat-list-item>
            <mat-icon style="color:green">check</mat-icon>
            <span class="add-margin">Packaged as an <a href="https://www.w3schools.com/whatis/whatis_npm.asp" target="_blank">NPM Library</a></span> 
          </mat-list-item>
        </mat-list>
      </div>
  ...
  <mat-tab-group>
    ...
    <mat-tab label="Documentation">
      ...
      <div fxLayout="column" fxLayout.gt-sm="row" fxLayoutGap="32px">
        ...
        <p fxFlex>
          ...
          <br><br>
          This has facilitated better testing, reduced the need for simple support questions, and improved confidence from
          Citi developers and managers that they can rely on our quality while easily transferring the knowledge of our
          library API as developers rotate roles.
        </p>
      </div>
    </mat-tab>
    ...
    <div fxLayout="column" fxLayout.gt-sm="row" fxLayoutGap="32px">
      ...
      ></iframe>
      <p fxFlex>
        Not long after we launched our documentation, we began measuring it effectiveness. Not only did the total number of defects
        ...
        <br><br>
        As of February 2019, there were 9,091 instances of our components used in citi.com, by June that increased to 10,980;
        an increase of 21%. By September, usage increased to 11,693. This increase in adoption not only means we are successfully
        servicing our higher-order users, but that iteration speed has improved, and the user experience is more consistent across
    ...
    <div fxLayout="column" fxLayout.gt-sm="row" fxLayoutGap="32px">
      ...
      <p fxFlex>
        ...
        our quarterly merge has allowed us to both continue enhancing our components for new features, while
        avoiding defects to unrelated features. Teams can plan their regression testing around these mereges, and
        still get the benefits of our enhancements.
      </p>
    </div>
    </mat-tab>
    ...
    <mat-tab label="Iteration">
      ...
      <div fxLayout="column" fxLayout.gt-sm="row" fxLayoutGap="32px">
        ...
        <p fxFlex>
          ...
          every code check in. Each check in also links back to the underlying story. I also created automation script
          to redeploy our documentation and new versions of our library, which I converted into the NPM format.
          <br><br>
          This has facilitated a more rapid development process that has directly impacted the design iteration, both for our
    ...
    <mat-tab label="Accessibility">
      ...
      <div fxLayout="column" fxLayout.gt-sm="row" fxLayoutGap="32px">
        ...
        <p fxFlex>
          ...
          a11y compliance. I work closely with <a href="https://www.deque.com/" taget="_blank">Deque</a> to review our library on a cadence,
  ...
  <section>
    ...
    <p>
      ...
      application as the features themselves. For one to execute such a vision, one must have the application
      architecture skills to implement it.
    </p>
    <p>
      My team falls under the "enable" domain along with the container team which manages the application
      shell through which the citi.com application is deployed. Because we share the same boss, every full time
      employee on that team once once on my team, and because I am considered to be the foremost subject
      matter expert for our frontend technology, I have been afforded to create a brand new container to
      ...
      fully SSR compatible, and facilitate the migration plan.
    </p>
    <p>
      As I write this, I'm finding it difficult to concisely
